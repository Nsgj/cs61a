...
def delete(t, target):
    ...
    if is_leaf(t):
        ...
        new_branch = [delete(i,target) for i in subtrees(t)]
        new_branch = [x for x in new_branch if x != []]
    return tree(entry(t),new_branch)
   

# ADT
>>>>>>> 3f59586e33bd14f965340f1c5a389021e04f0129
import inspect
